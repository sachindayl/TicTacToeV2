    ...
    public void delayDialog() {
        th = new Thread() {
            public void run() {
                try {
                    Thread.sleep(1500);
                    OnePlayerActivity5.this.runOnUiThread(new Runnable() {
                        public void run() {
                            alert = new AlertDialog.Builder(
                                    OnePlayerActivity5.this);
                ...
                .setPositiveButton("Yes",
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                                int which) {
                                OnePlayerActivity5.this.finish();
                                startActivity(end);
                            }
                        ...
                        public void run() {
                            ...
                            if (oneOne && one.isEnabled()) {
                                if (twoFour && twoFive && six.isEnabled()) {
                                    six.performClick();
                                } else if (twoFive && twoSix
                                        && four.isEnabled()) {
                                    four.performClick();
                                } else if (twoFour && twoSix
                                        && five.isEnabled()) {
                                    five.performClick();
                                } else if (twoSeven && twoEight
                                        && nine.isEnabled()) {
                                    nine.performClick();
                                } else if (twoEight && twoNine
                                        && seven.isEnabled()) {
                                    seven.performClick();
                                } else if (twoSeven && twoNine
                                        && eight.isEnabled()) {
                                    eight.performClick();
                                } else if (twoTwo && twoFive
                                        && eight.isEnabled()) {
                                    eight.performClick();
                                } else if (twoTwo && twoEight
                                        && five.isEnabled()) {
                                    five.performClick();
                                } else if (twoFive && twoEight
                                        && two.isEnabled()) {
                                    two.performClick();
                                } else if (twoThree && twoSix
                                        && nine.isEnabled()) {
                                    nine.performClick();
                                } else if (twoThree && twoNine
                                        && six.isEnabled()) {
                                    six.performClick();
                                } else if (twoSix && twoNine
                                        && three.isEnabled()) {
                                    three.performClick();
                                } else if (twoThree && twoFive
                                        && seven.isEnabled()) {
                                    seven.performClick();
                                } else if (twoThree && twoSeven
                                        && five.isEnabled()) {
                                    five.performClick();
                                } else if (twoFive && twoSeven
                                        && three.isEnabled()) {
                                    three.performClick();
                            ...
                            if (oneTwo && two.isEnabled()) {
                                if (twoOne && twoFour && seven.isEnabled()) {
                                    seven.performClick();
                                } else if (twoOne && twoSeven
                                        && four.isEnabled()) {
                                    four.performClick();
                                } else if (twoFour && twoSeven
                                        && one.isEnabled()) {
                                    one.performClick();
                                } else if (twoThree && twoSix
                                        && nine.isEnabled()) {
                                    ...
                                    six.performClick();
                                        ...
                                        && three.isEnabled()) {
                                    three.performClick();
                                } else if (twoOne && twoFive
                                        && nine.isEnabled()) {
                                    nine.performClick();
                                } else if (twoOne && twoNine
                                        && five.isEnabled()) {
                                    five.performClick();
                                } else if (twoFive && twoNine
                                        && one.isEnabled()) {
                                    one.performClick();
                                } else if (twoThree && twoFive
                                        && seven.isEnabled()) {
                            ...
                            if (oneFour && four.isEnabled()) {
                                ...
                                if (twoOne && twoTwo && three.isEnabled()) {
                                    three.performClick();
                                } else if (twoOne && twoThree
                                        && two.isEnabled()) {
                                    two.performClick();
                                } else if (twoTwo && twoThree
                                        && one.isEnabled()) {
                                    one.performClick();
                                }
                                // 3 6 9
